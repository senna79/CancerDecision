...
export const BREAST_SEQUENCING_ENTRY_CARDS = {
  whatIs: {
    lead: "Neoadjuvant chemotherapy (or neoadjuvant systemic therapy) means starting medicines — often chemotherapy, and sometimes other agents by subtype — before surgery in breast cancer. The other common path is adjuvant therapy after surgery. Sequencing is deciding which order fits your goals.",
    close:
  ...
  chemoOrRadiation: {
    lead: "After surgery, chemo and radiation are often both in the plan for some people — but they are usually sequenced, not chosen as “either/or in breast cancer.” Many plans complete systemic therapy first, then radiation; exact order depends on your pathology, reconstruction, and team practice.",
    ask: [
  ...
  whyMatters: {
    lead: "Timing is not a minor calendar detail in breast cancer. The sequence can change:",
    items: [
  ...
  notStronger: {
    lead: "This decision is not “which approach is stronger in the abstract in breast cancer.” Both sequences can be medically appropriate for different people.",
    close:
  ...
  subtypeFirst: {
    lead: "Subtype (ER/PR, HER2, and related biology) often shapes whether starting medicines before surgery is even on the table — and which medicines would be discussed in breast cancer.",
    close:
      "If subtype results are incomplete, ask whether sequencing should wait until the biology picture is clear.",
  },
  beforeSurgery: {
    lead: "“Chemo before surgery” usually means starting systemic therapy (often chemotherapy, and sometimes other medicines by subtype) before the operation in breast cancer. Teams may discuss this when they want to:",
    items: [
  ...
  normalBefore: {
    lead: "Yes — for many people with certain subtypes, stages, or surgical goals, starting systemic therapy before surgery is a standard option, not an emergency-only path in breast cancer.",
    items: [
  ...
  nodesClear: {
    lead: "Clear lymph nodes are important information, but they do not automatically mean “no chemotherapy in breast cancer.” Doctors also weigh subtype, tumor size, genomic assays (when relevant), and overall recurrence risk.",
    ask: [
  ...
  gapAfterSurgery: {
    lead: "When chemotherapy is planned after surgery, it usually starts after enough healing — often measured in weeks, not the next day in breast cancer. Exact timing depends on wound healing, complications, pathology results, and the overall sequence.",
    ask: [
  ...
  afterSurgery: {
    lead: "For breast cancer, surgery first, then systemic therapy afterward (adjuvant), may be discussed when:",
    items: [
  ...
  whatChanges: {
    lead: "Ask what would change the recommendation between before-surgery and after-surgery sequencing in breast cancer. Common factors include:",
    items: [
  ...
  response: {
    lead: "If treatment starts before surgery, ask how the team will know whether it is working — and what happens if response is less than hoped in breast cancer.",
    ask: [
  ...
  surgeryLink: {
    lead: "Sequencing and surgery choice are connected, but they are not the same decision in breast cancer. Timing asks when systemic therapy starts; surgery asks which operation fits.",
    close:
  ...
  timeline: {
    lead: "Ask for a plain-language timeline: what happens in the next weeks, how long neoadjuvant therapy would last if chosen, and when surgery would be planned in breast cancer.",
    ask: [
  ...
  pendingInfo: {
    lead: "For breast cancer, before locking sequencing, confirm whether important information is still pending:",
    items: [
  ...
  lifeFit: {
    lead: "Sequencing also affects daily life — work leave, childcare, fertility timing, travel to infusions, and recovery after surgery in breast cancer.",
    ask: [
  ...
  thisWeek: {
    lead: "For breast cancer, if sequencing is the decision in front of you, focus on:",
    steps: [
  ...
  mistakes: {
    lead: "For breast cancer, common sequencing mistakes include:",
    items: [
      {
...
export const BREAST_SEQUENCING_DIRECT_ANSWER = `The choice of whether breast cancer treatment starts before or after surgery depends on subtype, stage and extent, and what your team is trying to learn or achieve. Some people start medicines first; others have surgery first, then systemic therapy. Neither order is automatically stronger for everyone. Ask: for my subtype and stage, should treatment start before or after surgery — and what would change that recommendation?`;
