...
export const BREAST_FOLLOW_UP_ENTRY_CARDS = {
  whatHappens: {
    lead: "After active treatment ends, follow-up usually looks like a structured plan — visits, exams, selected imaging, and monitoring of ongoing medicines — not a sudden stop to care in breast cancer. It continues because:",
    items: [
  ...
  notWaiting: {
    lead: "The goal is not to spend your life waiting for bad news in breast cancer. The goal is a clear plan:",
    items: [
  ...
  firstVisit: {
    lead: "For breast cancer, a follow-up visit may include:",
    items: [
  ...
  whoManages: {
    lead: "Your care may involve medical oncology, surgery, radiation, primary care, and other specialists in breast cancer. Ask:",
    ask: [
  ...
  schedule: {
    lead: "How often you see your oncologist after treatment depends on your situation — subtype, stage, treatments received, ongoing medicines, and risk assessment in breast cancer. Many people have more frequent visits early, then space them out; there is no single universal calendar.",
    ask: [
  ...
  guidelines: {
    lead: "Follow-up schedules are usually shaped by clinical guideline frameworks plus your personal details — subtype, treatments received, reconstruction status, ongoing endocrine therapy, and risk in breast cancer. Your plan should be individualized, not copied from a generic chart alone.",
    ask: [
  ...
  cancerFree: {
    lead: "“Cancer-free” language varies in breast cancer. Teams may say there is no evidence of disease (NED) on exams and imaging, while follow-up continues because recurrence risk is never zero and ongoing medicines or late effects still need monitoring. There is rarely a single day when surveillance suddenly stops for everyone.",
    ask: [
  ...
  moreScans: {
    lead: "Not necessarily in breast cancer. Doctors balance useful information, possible stress, cost, and unnecessary procedures.",
    close: "The best plan is the right monitoring plan for you — not the densest one.",
  },
  endocrine: {
    lead: "If you are on endocrine therapy or other long-term medicines, follow-up often includes checking side effects, adherence, bone or heart health when relevant, and whether the plan still fits in breast cancer.",
    ask: [
  ...
  whichSymptoms: {
    lead: "Ask your doctor which symptoms matter most for your situation in breast cancer. Examples may include:",
    items: [
  ...
  betweenVisits: {
    lead: "Do not wait automatically in breast cancer. Ask your healthcare team:",
    ask: [
  ...
  longTermEffects: {
    lead: "Some effects may continue after treatment in breast cancer. Depending on your care, discuss:",
    items: [
  ...
  thisWeek: {
    lead: "For breast cancer, if you are entering follow-up, focus on:",
    steps: [
  ...
  mistakes: {
    lead: "For breast cancer, common follow-up mistakes include:",
    items: [
      {
