...
export const BREAST_METASTATIC_ENTRY_CARDS = {
  ...
  notGivingUp: {
    lead: "Different goals do not mean doctors are giving up. They mean the plan is designed around control, symptoms, and living with breast cancer — not only around a single curative path.",
    close:
      "Your team is still making active decisions with you, including which treatments may help and what trade-offs matter.",
  },
  subtypeStillMatters: {
    lead: "Subtype still shapes the conversation in metastatic disease — HR+, HER2+, and triple-negative paths often open different medicine families in breast cancer.",
    items: [
  ...
  differentPlans: {
    lead: "For breast cancer, people with the same Stage IV label often hear different plans because doctors also consider:",
    items: [
  ...
  strongest: {
    lead: "For breast cancer, not always. A good choice balances possible benefit, side effects, your goals, and daily life — not only intensity.",
    close:
      "More aggressive is not automatically a better fit for metastatic decision-making.",
  },
  localTherapy: {
    lead: "Surgery or radiation may still be discussed for specific problems — for example painful bone sites or limited metastases — even when the overall plan is systemic in breast cancer.",
    ask: [
  ...
  infoNeeded: {
    lead: "For breast cancer, before locking a first metastatic plan, confirm whether key information is available:",
    items: [
  ...
  options: {
    lead: "Metastatic treatment options are usually discussed as families that fit your subtype, prior therapy, and goals — not one fixed “Stage IV list in breast cancer.” Common families include endocrine therapy (for HR+), HER2-targeted therapy (for HER2+), chemotherapy, immunotherapy in selected TNBC settings, other targeted agents, local therapy for specific sites, supportive care, and clinical trials.",
    ask: [
  ...
  whatToAsk: {
    lead: "For breast cancer, a focused Stage IV conversation usually covers goals, options, trade-offs, and what starts now:",
    ask: [
  ...
  secondOpinion: {
    lead: "A second opinion may help when options feel complex, recommendations conflict, or you want more confidence before locking a first metastatic plan in breast cancer.",
    close:
      "It is about confidence, not distrust — especially when goals and trade-offs are high-stakes.",
  },
  clinicalTrial: {
    lead: "A clinical trial may be another option depending on subtype, prior treatment, and eligibility in breast cancer. Trials are not only “last resort.”",
    close:
      "Ask whether any trials fit your situation — and how they compare with standard options.",
  },
  thisWeek: {
    lead: "For breast cancer, if metastatic decisions are in front of you, focus on:",
    steps: [
  ...
  mistakes: {
    lead: "For breast cancer, common metastatic-decision mistakes include:",
    items: [
      {
