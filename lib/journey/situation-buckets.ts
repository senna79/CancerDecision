...
export const BREAST_SITUATION_BUCKETS: SituationBucket[] = [
  ...
  },
  {
    ...
    momentIds: ["second-opinion", "care-center-expertise", "global-care"],
    alsoMomentIds: ["surgery-decision", "treatment-sequencing", "clinical-trial"],
  },
  {
    id: "cancer-changed",
  ...
  },
  {
    ...
    alsoMomentIds: ["second-opinion", "quality-of-life", "stage-iv-options"],
  },
];
